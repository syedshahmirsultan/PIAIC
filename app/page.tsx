...
<Link href="/Web"> <div className="h-[300px]  w-[400px] bg-black-900 ml-[200px]  border-2 border-purple-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<h1 className="text-[25px] text-center text-purple-900 mt-[30px] font-bold">Web 3.0 and Metaverse developer</h1>
 ...
 <Link href="/Cloud"> <div className="h-[300px]  w-[400px] bg-black-900 ml-[300px] border-2 border-green-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<Link href="/Genomics"> <div className="h-[300px]  w-[400px] bg-black-900 ml-[400px] border-2 border-teal-500 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Network"> <div className="h-[300px]  w-[400px] bg-black-900 ml-[800px]  border-2 border-pink-600 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
