...
<p className="text-[25px] text-blue-800 ml-[400px] mt-[20px] pr-[200px]">The mission of PIAIC is to reshape Pakistan by revolutionizing education, research, and business by adopting latest, cutting-edge technologies. Experts are calling this the 4th industrial revolution. We want Pakistan to become a global hub for AI, data science, cloud native computing, edge computing, blockchain, augmented reality, and internet of things.</p>
 ...
 <div className="h-[1400px] w-2/2">
  <h1 className=" mt-[50px] text-gray-700 text-[65px] text-center">Available Programs</h1>
...
<Link href="/Web"> <div className="h-[200px]  w-[400px] bg-black-900 ml-[300px] mt-[-300px] border-2 border-purple-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<h1 className="text-[25px] text-center text-purple-900 mt-[30px] font-bold">Web 3.0 and Metaverse developer</h1>
 ...
 <Link href="/Cloud"> <div className="h-[200px]  w-[400px] bg-black-900 ml-[500px] mt-[-980px] border-2 border-green-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<Link href="/Iot"> <div className="h-[200px]  w-[400px] bg-black-900 ml-[100px] mt-[100px] border-2 border-red-700 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Genomics"> <div className="h-[200px]  w-[400px] bg-black-900 ml-[300px] mt-[-300px] border-2 border-teal-500 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Network"> <div className="h-[200px]  w-[400px] bg-black-900 ml-[500px] mt-[-300px]  border-2 border-pink-600 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<div className=' mt-[200px] bg-teal-500 h-[750px] w-2/2'>
  ...
  <Image src="/images/panapic.jpg" alt="picture of inaguration of PIAIC" height={400} width={800} className="ml-[50px] mt-[50px]"/>
   <h1 className="text-black-900 text-[40px] pl-[720px]  mt-[-450px] font-sans font-extrabold]">
   <strong> President launching PIAIC Website</strong> </h1>
 <p className="text-white text-[25px] text-left pl-[720px] mt-[20px] pr-[20px]">President Dr. Arif Alvi launching the official website of PIAIC on December 9,3018.
...
<div className="h-[350px] w-2/2 bg-gray-300">
  <h1 className="text-blue-900  font-extrabold text-center text-[50px] mt-[8px]"><strong>Strategic Partners
