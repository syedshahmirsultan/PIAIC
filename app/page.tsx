...
export default function Home(){
  return(
    ...
    <Link href="https://en.wikipedia.org/wiki/Arif_Alvi"><Image src="/images/president2.jpg" alt="picture of President" height={900} width={400}  className="mt-[40px] ml-[50px] "/></Link>
      <h1 className="font-extrabold text-[69px] text-blue-800 ml-[600px] font-sans mt-[50px]"><strong>Presidential Initiative</strong></h1>
...
<h1 className="text-[25px] text-center text-purple-900 mt-[50px] font-bold">Web 3.0 and Metaverse developer</h1>
 ...
 <Link href="/Cloud"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[800px] mt-[50px] border-2 border-green-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<Link href="/Genomics"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[400px] mt-[50px] border-2 border-teal-500 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Network"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[800px] mt-[50px] border-2 border-pink-600 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
