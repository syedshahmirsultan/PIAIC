...
<Link href="/Artificial"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[50px] border-2 border-blue-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<h1 className="text-[25px] text-center text-purple-900 mt-[30px] font-bold">Web 3.0 and Metaverse developer</h1>
 ...
 <Link href="/Cloud"> <div className="h-[200px] w-[300px] bg-black-900 border-2 ml-[50px] border-green-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<Link href="/Iot"> <div className="h-[200px]  w-[300px] bg-black-900   ml-[50px] border-2 border-red-700 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Genomics"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[50px] border-2 border-teal-500 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Network"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[50px] border-2 border-pink-600 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
