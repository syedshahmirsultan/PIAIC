...
export default function Home(){
  return(
    ...
    <Link href="https://en.wikipedia.org/wiki/Arif_Alvi"><Image src="/images/president2.jpg" alt="picture of President" height={800} width={300}  className="mt-[40px] ml-[50px] "/></Link>
      <h1 className="font-extrabold text-[65px] text-blue-800 ml-[600px] font-sans mt-[-650px]"><strong>Presidential Initiative</strong></h1>
      <h1 className='text-[45px] text-blue-800 ml-[600px] mt-[30px]'>
for Artificial Intelligence & Computing (PIAIC)</h1>
<p className="text-[25px] text-blue-800 ml-[600px] mt-[20px] pr-[300px]">The mission of PIAIC is to reshape Pakistan by revolutionizing education, research, and business by adopting latest, cutting-edge technologies. Experts are calling this the 4th industrial revolution. We want Pakistan to become a global hub for AI, data science, cloud native computing, edge computing, blockchain, augmented reality, and internet of things.</p>
...
<Link href="/Artificial"> <div className="h-[100px] mt-[100px] w-[200px] bg-black-900 ml-[200px] border-2 border-blue-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<div className=' mt-[300px] bg-teal-500 h-[750px] w-2/2'>
  ...
  <Image src="/images/panapic.jpg" alt="picture of inaguration of PIAIC" height={800} width={900} className="ml-[50px] mt-[50px]"/>
   <h1 className="text-black-900 text-[40px] pl-[1020px]  mt-[-530px] font-sans font-extrabold]">
