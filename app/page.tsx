...
<Link href="/Web"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[300px] mt-[50px] border-2 border-purple-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
 <div className="h-[50px] w-2/2 bg-purple-900"> 
    </div>
<h1 className="text-[25px] text-center text-purple-900 mt-[50px] font-bold">Web 3.0 and Metaverse developer</h1>
</div></Link>
 </div>
 <Link href="/Cloud"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[1100px] mt-[50px] border-2 border-green-900 transition duration-150 ease-out transform hover:scale-125 hover:-translate-y-[50px]">
...
<Link href="/Genomics"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[600px] mt-[50px] border-2 border-teal-500 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<Link href="/Network"> <div className="h-[200px]  w-[300px] bg-black-900 ml-[1100px] mt-[50px] border-2 border-pink-600 transition duration-150 ease-out transform hover:scale-125 hover:translate-y-[50px]">
...
<div className="h-[350px] w-2/2 bg-gray-300">
  <h1 className="text-blue-900  font-extrabold text-center text-[65px] pt-[30px]"><strong>Strategic Partners
   ...
   <Link href="https://saylaniwelfare.com/en"><Image src="/images/saylani.jpg" height={100} width={200} alt="Logo of Saylani Welfare Trust" 
    className="ml-[400px] mt-[-150px]"/></Link>
</div>
 </div>
